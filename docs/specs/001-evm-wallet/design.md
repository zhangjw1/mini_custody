...
| RPC 客户端 | `internal/chain/evm` 封装 `go-ethereum/ethclient`，业务层只依赖 `EVMClient` |
...
SEPOLIA_RPC_TIMEOUT=10s
SEPOLIA_RPC_MAX_ATTEMPTS=3
SEPOLIA_RPC_BASE_DELAY=250ms
SEPOLIA_RPC_MAX_DELAY=3s
